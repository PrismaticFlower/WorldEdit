...
TEST_CASE("world save blocks (stairways floating)", "[World][IO]")
{
   const std::string_view expected_blk = R"(Custom(3)
{
   StairwayFloating()
...
Materials()
{
   ...
   save_blocks("temp/blocks/test_stairways_floating.blk", blocks);

   const auto written_blk =
      io::read_file_to_string("temp/blocks/test_stairways_floating.blk");
...
TEST_CASE("world save blocks (beveled boxes)", "[World][IO]")
{
   const std::string_view expected_blk = R"(Custom(3)
{
   BeveledBox()
...
Materials()
{
   ...
   save_blocks("temp/blocks/test_beveled_boxes.blk", blocks);

   const auto written_blk =
      io::read_file_to_string("temp/blocks/test_beveled_boxes.blk");

   CHECK(written_blk == expected_blk);
}

TEST_CASE("world save blocks (rings)", "[World][IO]")
{
   const std::string_view expected_blk = R"(Custom(3)
{
   Ring()
...
Materials()
{
   ...
   save_blocks("temp/blocks/test_rings.blk", blocks);

   const auto written_blk =
      io::read_file_to_string("temp/blocks/test_rings.blk");

   CHECK(written_blk == expected_blk);
}

TEST_CASE("world save blocks (curves)", "[World][IO]")
{
   const std::string_view expected_blk = R"(Custom(3)
{
   CubicCurve()
...
Materials()
{
   ...
   save_blocks("temp/blocks/test_curves.blk", blocks);

   const auto written_blk =
      io::read_file_to_string("temp/blocks/test_curves.blk");

   CHECK(written_blk == expected_blk);
}

TEST_CASE("world save blocks (arches)", "[World][IO]")
{
   const std::string_view expected_blk = R"(Custom(3)
{
   Arch()
...
Materials()
{
   ...
   save_blocks("temp/blocks/test_arches.blk", blocks);

   const auto written_blk =
      io::read_file_to_string("temp/blocks/test_arches.blk");
