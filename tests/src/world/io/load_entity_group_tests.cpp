...
TEST_CASE("world entity group loading (blocks, stairways)", "[World][IO]")
{
   ...
   CHECK(group.blocks.stairways.description[0].size == float3{4.0f, 4.0f, 4.0f});
   CHECK(group.blocks.stairways.description[0].step_height == 0.1f);
   CHECK(group.blocks.stairways.description[0].first_step_offset == 0.0f);
   ...
   CHECK(group.blocks.stairways.description[1].size == float3{8.0f, 4.0f, 8.0f});
   CHECK(group.blocks.stairways.description[1].step_height == 0.25f);
   CHECK(group.blocks.stairways.description[1].first_step_offset == 0.125f);
   ...
   CHECK(group.blocks.stairways.description[2].size == float3{5.0f, 5.0f, 5.0f});
   CHECK(group.blocks.stairways.description[2].step_height == 1.0f);
   CHECK(group.blocks.stairways.description[2].first_step_offset == 0.0f);
