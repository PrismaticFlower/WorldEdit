                   ...
                   .position_keys =
                      {
                         ...
                         world::position_key{.time = 5.0f, .position = {8.0f, 8.0f, 8.0f}},
                      },
                },
             },
          }};
...
TEST_CASE("edits insert_animation_key", "[Edits]")
{
   world::world world = test_world_insert_animation;
   ...
   auto action =
      make_insert_animation_key(&world.animations[0].position_keys, 1, key);
   ...
   CHECK(world.animations[0].position_keys[1].time == 4.0f);
   CHECK(world.animations[0].position_keys[2].time == 5.0f);
