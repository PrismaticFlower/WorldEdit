...
constexpr auto index(float2& v, const uint64 i) noexcept -> float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
...
constexpr auto index(float3& v, const uint64 i) noexcept -> float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
   if (i == 2) return v.z;
...
constexpr auto index(float4& v, const uint64 i) noexcept -> float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
   if (i == 2) return v.z;
...
constexpr auto index(const float2& v, const uint64 i) noexcept -> const float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
...
constexpr auto index(const float3& v, const uint64 i) noexcept -> const float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
   if (i == 2) return v.z;
...
constexpr auto index(const float4& v, const uint64 i) noexcept -> const float&
{
   if (i == 0) return v.x;
   if (i == 1) return v.y;
   if (i == 2) return v.z;
