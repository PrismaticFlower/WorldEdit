                 ...
                 blocks& blocks_out)
{
   for (const auto& key_node : node) {
      ...
      if (iequals(key_node.key, "Stairway")) {
      ...
      else if (iequals(key_node.key, "StairwayFloating")) {
      ...
      else if (iequals(key_node.key, "Ring")) {
         ...
         for (const auto& prop : key_node) {
            ...
            else if (iequals(prop.key, "InnerRadius")) {
               ring.inner_radius = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "OuterRadius")) {
               ring.outer_radius = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "Height")) {
      ...
      else if (iequals(key_node.key, "BeveledBox")) {
         ...
         for (const auto& prop : key_node) {
            ...
            else if (iequals(prop.key, "Amount")) {
               beveled_box.amount = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "BevelTop")) {
               beveled_box.bevel_top = prop.values.get<int>(0) != 0;
            }
            else if (iequals(prop.key, "BevelSides")) {
               beveled_box.bevel_sides = prop.values.get<int>(0) != 0;
            }
            else if (iequals(prop.key, "BevelBottom")) {
      ...
      else if (iequals(key_node.key, "CubicCurve")) {
         ...
         for (const auto& prop : key_node) {
            ...
            else if (iequals(prop.key, "Width")) {
      ...
      else if (iequals(key_node.key, "Cone")) {
      ...
      else if (iequals(key_node.key, "Arch")) {
         ...
         for (const auto& prop : key_node) {
            ...
            else if (iequals(prop.key, "CrownLength")) {
               arch.crown_length = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "CrownHeight")) {
               arch.crown_height = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "CurveHeight")) {
               arch.curve_height = prop.values.get<float>(0);
            }
            else if (iequals(prop.key, "SpanLength")) {
