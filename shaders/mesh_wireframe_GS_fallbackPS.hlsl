...
{
   const float4 positionPS0 = input_vertex.flat_positionPS[0];
   const float4 positionPS1 = input_vertex.flat_positionPS[1];
   const float4 positionPS2 = input_vertex.flat_positionPS[2];
